...
const useMitigationLinks = (
  ...
  const handleRemoveMitigationLinks = useCallback(
  ...
  const handlRemoveMitigationLinksByMitigationId = useCallback(
    async (mitigationId: string) => {
      setMitigationLinkList((prevList) =>
        prevList.filter((x) => !(x.mitigationId === mitigationId)),
      );
    },
    [setMitigationLinkList],
  );
  ...
  const handleAddMitigationLinks = useCallback(
    (mitigationLinks: MitigationLink[]) => {
      setMitigationLinkList((prevList) => {
  ...
  const handleGetLinkedMitigationLinks = useCallback(
  ...
  const handleGetMitigationThreatLinks = useCallback(
    (mitigationId: string) => {
