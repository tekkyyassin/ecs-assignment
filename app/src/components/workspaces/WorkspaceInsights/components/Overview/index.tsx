...
const Overview: FC = () => {
  ...
  return (
    <ColumnLayout columns={8} variant="text-grid" minColumnWidth={100}>
      <LabelValuePair
        label="Total"
        value={statementList.length}
        onLinkFollow={handleLinkClicked()}
      />
      <LabelValuePair
        label="No mitigation and assumption"
        showWarning
      ...
      />
      <LabelValuePair
        label={<Badge color="red">High</Badge>}
        value={countHigh}
        onLinkFollow={handleLinkClicked({
          priority: LEVEL_HIGH,
        })}
      />
      <LabelValuePair
        label={<Badge color="blue">Med</Badge>}
        value={countMed}
        onLinkFollow={handleLinkClicked({
      ...
      />
      <LabelValuePair
        label={<Badge color="green">Low</Badge>}
        value={countLow}
        onLinkFollow={handleLinkClicked({
          priority: LEVEL_LOW,
        })}
