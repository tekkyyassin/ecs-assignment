  ...
  return (
    <InfoModalBase title="threat-composer">
      <p>
        ...
        , with the aim of making it faster and easier for you to
      </p>
      <div css={css(styles.featureSets)}>
        ...
        >
          <div css={[css(styles.featureSet), css(styles.contentBaseText)]}>
            ...
            <span>
              Focus your brainstorming of custom and contextual threats
            </span>
          </div>
          <div css={[css(styles.featureSet), css(styles.contentBaseText)]}>
            <div>
            ...
            <span>
              Iteratively compose useful threats with the time you have
              available
            </span>
          </div>
        </Grid>
