    ...
    >
      {editMode ? (
        <SpaceBetween direction="vertical" size="l">
          <FormField label="Application or feature name">
            <Input
              value={name}
          ...
          <FormField label="Cloud service model">
            <Checkbox
              onChange={({ detail }) => setCheckedIaaS(detail.checked)}
              checked={checkedIaaS}
            >
              IaaS
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedPaaS(detail.checked)}
              checked={checkedPaaS}
            >
              PaaS
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedSaaS(detail.checked)}
              checked={checkedSaaS}
            >
              SaaS
            </Checkbox>
          </FormField>
          <FormField label="Cloud stack component">
            <Checkbox
              onChange={({ detail }) => setCheckedData(detail.checked)}
              checked={checkedData}
            >
              Data
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedStorage(detail.checked)}
              checked={checkedStorage}
            >
              Storage
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedApplication(detail.checked)}
              checked={checkedApplication}
            >
              Application
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedCompute(detail.checked)}
              checked={checkedCompute}
            >
              Compute
            </Checkbox>
            <Checkbox
              onChange={({ detail }) => setCheckedNetwork(detail.checked)}
