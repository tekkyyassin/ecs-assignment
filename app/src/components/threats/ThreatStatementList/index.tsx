...
const ThreatStatementList: FC<ThreatStatementListProps> = ({
  ...
  const [selectedPriorities, setSelectedPriorities] = useState<string[]>(
    initialFilter && initialFilter.priority ? [initialFilter.priority] : [],
  );
  ...
  const handleAddTagToStatement = useCallback(
    (statement: TemplateThreatStatement, tag: string) => {
  ...
  const handleRemoveTagFromStatement = useCallback(
    (statement: TemplateThreatStatement, tag: string) => {
