...
const threatStatementFormat: ThreatStatementFormat = {
  ...
  15: {
    template:
      "A [threat_source] [prerequisites] can [threat_action], which leads to [threat_impact]",
    suggestions: [
  ...
  23: {
    template:
      "A [threat_source] [prerequisites] can [threat_action], resulting in reduced [impacted_goal]",
    suggestions: [
  ...
  31: {
    template:
      "A [threat_source] [prerequisites] can [threat_action], which leads to [threat_impact], resulting in reduced [impacted_goal]",
    suggestions: [
      "[impacted_assets] Consider which assets are being impacted. It is important to understand the impact of the risk, and to help with prioritisation",
    ],
  },
  39: {
    template:
      "A [threat_source] [prerequisites] can [threat_action], negatively impacting [impacted_assets]",
    suggestions: [
      "[threat_impact] Consider if there is any initial impact of the threat as a result of the threat action being successful",
      "[impacted_goal] Consider which specific desirable goal (e.g. confidentially) is being diminished against the listed assests. It is important to understand the impact of the risk, and to help with prioritisation",
    ],
  ...
  55: {
    template:
      "A [threat_source] [prerequisites] can [threat_action], resulting in reduced [impacted_goal] of [impacted_assets]",
    suggestions: [
